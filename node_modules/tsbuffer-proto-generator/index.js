    ...
    async _addRefToOutput(ref, astKey, name, output, astCache, logger) {
        ...
        if (pathMatch) {
            ...
            // 绝对路径引用 resolveModule
                ...
                refPath = path__default["default"].relative(this.options.baseDir, this.options.resolveModule(pathMatch[1]));
            }
        }
        // 当前文件内引用
        else {
...
const defaultResolveModule = importPath => path__default["default"].join('node_modules', importPath);
