            ...
            this.httpServer = (this.options.https ? https : http).createServer({
                ...
                httpReq.on('end', async () => {
                    ...
                    if (conn.dataType === 'text') {
                        ...
                        let serviceId;
                        if (isMsg) {
                            serviceId = (_c = this.serviceMap.msgName2Service[serviceName]) === null || _c === void 0 ? void 0 : _c.id;
                        }
                        else {
                            serviceId = (_d = this.serviceMap.apiName2Service[serviceName]) === null || _d === void 0 ? void 0 : _d.id;
                        }
